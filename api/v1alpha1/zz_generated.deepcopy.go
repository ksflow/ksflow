...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlobalSchemaRegistryConfig) DeepCopyInto(out *GlobalSchemaRegistryConfig) {
	*out = *in
	if in.GlobalSchemaRegistryURL != nil {
		in, out := &in.GlobalSchemaRegistryURL, &out.GlobalSchemaRegistryURL
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalSchemaRegistryConfig.
func (in *GlobalSchemaRegistryConfig) DeepCopy() *GlobalSchemaRegistryConfig {
	if in == nil {
		return nil
	}
	out := new(GlobalSchemaRegistryConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KsflowConfig) DeepCopyInto(out *KsflowConfig) {
	*out = *in
	...
	if in.GlobalSchemaRegistryConfig != nil {
		in, out := &in.GlobalSchemaRegistryConfig, &out.GlobalSchemaRegistryConfig
		*out = new(GlobalSchemaRegistryConfig)
		(*in).DeepCopyInto(*out)
	}
}
